...
# tester2 = ConsecutiveNPChunker(features_prevnext, training)
# tester3 = ConsecutiveNPChunker(features_luka_countries, training)
# tester4 = ConsecutiveNPChunker(features_best, training)
# tester5 = ConsecutiveNPChunker(features_best_BV, training)
# tester6 = ConsecutiveNPChunker(features_luka_names, training)
# tester7 = ConsecutiveNPChunker(features_luka_whole_bimbam, training)
# print(test_nl_NER.evaluate(testing))
# print(tester2.evaluate(testing))
# print(tester3.evaluate(testing))
# print("^ Country model")
# print(tester4.evaluate(testing))
# print(tester5.evaluate(testing))
# print(tester6.evaluate(testing))
# print("^ Names model")
# print(tester7.evaluate(testing))
# print("^ Whole bimbam")
